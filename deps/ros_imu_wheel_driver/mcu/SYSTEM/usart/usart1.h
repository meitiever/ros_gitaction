...
#define  USART1_TRANSMIT_GROOVE_SIZE    3   //串口发送的最大条数
#define  USART1_TRANSMIT_BUFFER_SIZE    20   //串口一次发送最大字节数
#define  USART1_RECEIVE_GROOVE_SIZE     3    //串口接收的最大条数
#define  USART1_RECEIVE_BUFFER_SIZE     60   //串口一次发接收最大字节数
...
void vUart1_SendString(char * buf,int len);

void USART1_Config( void );
void uarts1SendDataDmaBlocking(u32 size, u8* data);
#endif
