...
*/
#ifndef SINEVA_COMMON_TESTING_ENTRYPOINT_H_
#define SINEVA_COMMON_TESTING_ENTRYPOINT_H_
...
#define SINEVA_UNITTEST_ENTRYPOINT          \
  int main(int argc, char** argv) {         \
    common::UnitTestEntryPoint entry_point; \
    return entry_point.run(argc, argv);     \
  }

#endif  // SINEVA_COMMON_TESTING_ENTRYPOINT_H_
