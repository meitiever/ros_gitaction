...
#ifndef SINEVA_SLAM_VSLAM_ASYNC_SERIAL_H
#define	SINEVA_SLAM_VSLAM_ASYNC_SERIAL_H
...
public:
    ...
    */
    ...
    void flushSerialPort(flush_type what, boost::system::error_code& error);    
...
#endif //SINEVA_SLAM_VSLAM_ASYNC_SERIAL_H
