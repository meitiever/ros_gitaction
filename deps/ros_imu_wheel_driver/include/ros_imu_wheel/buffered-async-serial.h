/* 
 * File:   buffered-async-serial.h
 * Author: Terraneo Federico
 * Distributed under the Boost Software License, Version 1.0.
 * Created on January 6, 2011, 3:31 PM
 */
#ifndef SINEVA_SLAM_VSLAM_BUFFERED_ASYNC_SERIAL_H
#define	SINEVA_SLAM_VSLAM_BUFFERED_ASYNC_SERIAL_H

#include <mutex>
#include <ros_imu_wheel/async-serial.h>
...
#endif //SINEVA_SLAM_VSLAM_BUFFERED_ASYNC_SERIAL_H
